...
public class Treatment {
    ...
    public String toString() {
        return String.format(
                "The treatment %s, %s, by %s costing %s, is administered from %s to %s to the patient %s by the doctor %s.%nIt will be taken with a frequency of %s and dosage of %s%n",
